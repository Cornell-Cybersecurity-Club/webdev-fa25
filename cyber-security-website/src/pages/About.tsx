    ...
    <div className="text-center py-10 px-5">
      ...
      <div className="flex gap-5 justify-center items-center mt-5">
          <div className="relative w-[700px] h-[200px] border-2 border-white p-[10px] rounded-lg">
            <p className="absolute -top-[15px] bg-[#000000] text-[#FF3B3B] w-[100px] text-lg"> About Us </p>
...
>>>>>>> 2098cc504781ef9aac7954a44cce76fdd0085bc7
        </div>
      </section>
      ...
      <div>
        <div className="flex gap-5 justify-center items-center mt-5">
          <div className="relative w-[500px] h-[200px] border-2 border-white p-[10px] rounded-lg">
            <p className="absolute -top-[15px] bg-[#000000] text-[#FF3B3B] w-[40px] text-lg"> NME </p>
            <p> Description Here</p>
          </div>
          <div className="relative w-[500px] h-[200px] border-2 border-white p-[10px] rounded-lg">
            <p className="absolute -top-[15px] bg-[#000000] text-[#FF3B3B] w-[40px] text-lg"> IME </p>
=======
...
<<<<<<< HEAD
        ...
        <div className="flex gap-5 justify-center mt-10">
          <div className="relative w-[500px] h-[200px] border-2 border-white p-[10px] rounded-lg">
            <p className="absolute -top-[15px] bg-[#000000] text-[#FF3B3B] w-[100px] text-lg"> CTF Team </p>
            <p> Description Here</p>
          </div>
          <div className="relative w-[500px] h-[200px] border-2 border-white p-[10px] rounded-lg">
            <p className="absolute -top-[15px] bg-[#000000] text-[#FF3B3B] w-[110px] text-lg"> CCDC Team </p>
=======
...
>>>>>>> 2098cc504781ef9aac7954a44cce76fdd0085bc7
      ...
      <div className="w-full min-h-screen text-[#E1DAD3] flex flex-col items-center">
        ...
        <section className="w-full flex justify-center py-20">
          <div className="bg-[#FA2136] rounded-xl px-10 py-12 text-center max-w-2xl w-full">
<<<<<<< HEAD
            <h2 className="text-xl text-[#000000] tracking-wide mb-6">READY TO JOIN?</h2>
=======
...
>>>>>>> 2098cc504781ef9aac7954a44cce76fdd0085bc7
        ...
        <section className="w-11/12 md:w-4/5 lg:w-3/5 h-64 bg-[#D9D9D9] text-[#000000] rounded-md flex items-center justify-center mb-8">
...
<<<<<<< HEAD
              ...
              <h3 className="absolute -top-[15px] bg-[#000000] text-[#FA2136] mb-3 font-semibold tracking-wide w-[50px]">ISTS</h3>
=======
            <div className=" relative border border-[#E1DAD3] rounded-xl p-6 min-h-[200px]">
...
>>>>>>> 2098cc504781ef9aac7954a44cce76fdd0085bc7
            ...
            <div className="relative border border-[#E1DAD3] rounded-xl p-6 min-h-[200px]">
<<<<<<< HEAD
              <h3 className="absolute -top-[15px] bg-[#000000] text-[#FA2136] mb-3 font-semibold tracking-wide w-[320px]">
=======
